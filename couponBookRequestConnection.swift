...
class couponBookRequestConnection: serverConnection {
    ...
    func getResponse(){
        ...
        let body = "<adm:getbyCommercialAreaCouponBookRequest><idUser>\(r_idUser)</idUser></adm:getbyCommercialAreaCouponBookRequest>"
