//
//  deleteCouponConnection.swift
//  AdmazingApp
//
//  Created by Cristopher Nunez Del Prado on 6/09/16.
//  Copyright © 2016 Cristopher Nunez Del Prado. All rights reserved.
//

import Foundation
class deleteCouponConnection: serverConnection {
    var r_idUser: String = ""
    ...
    func getResponse(){
        ...
        var body = "<adm:deleteFromCouponBookRequest><idUser>\(r_idUser)</idUser><idPromotion>\(r_idPromotion)</idPromotion></adm:deleteFromCouponBookRequest>"
