//
//  deletePreferenceConnection.swift
//  AdmazingApp
//
...
import Foundation
class deletePreferencesConnection: serverConnection {
    ...
    func getResponse(){
        ...
        var body = "<adm:deleteFromPreferenceRequest><idUser>\(r_userName)</idUser><idCategory>\(r_idCategory)</idCategory></adm:deleteFromPreferenceRequest>"
